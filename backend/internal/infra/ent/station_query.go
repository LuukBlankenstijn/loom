...
func (_q *StationQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *StationQuery) FirstIDX(ctx context.Context) int {
...
func (_q *StationQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *StationQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *StationQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *StationQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *StationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(station.Table, station.Columns, sqlgraph.NewFieldSpec(station.FieldID, field.TypeInt))
	_spec.From = _q.sql
