...
const (
	// Label holds the string label denoting the tableelement type in the database.
	Label = "table_element"
	...
	EdgeStation = "station"
	// Table holds the table name of the tableelement in the database.
	Table = "table_elements"
	// MapTable is the table that holds the map relation/edge.
	MapTable = "table_elements"
	...
	StationColumn = "table_element_station"
)

// Columns holds all SQL columns for tableelement fields.
var Columns = []string{
	FieldID,
	FieldX,
	FieldY,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "table_elements"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"contest_area_map_tables",
	"table_element_station",
}
...
func RotationValidator(r Rotation) error {
	...
	case Rotation0, Rotation90, Rotation180, Rotation270:
		return nil
	default:
		return fmt.Errorf("tableelement: invalid enum value for rotation field: %q", r)
	}
}

// OrderOption defines the ordering options for the TableElement queries.
