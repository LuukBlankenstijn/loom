...
func HasStation() predicate.Team {
...
func HasStationWith(preds ...predicate.Station) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := newStationStep()
...
func HasContests() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasContestsWith(preds ...predicate.Contest) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
