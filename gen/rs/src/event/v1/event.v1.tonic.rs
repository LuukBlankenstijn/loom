...
*/
        pub async fn subscribe(
            ...
            tonic::Response<tonic::codec::Streaming<super::SubscribtionEvent>>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod events_service_server {
    ...
    pub trait EventsService: std::marker::Send + std::marker::Sync + 'static {
        ...
        type SubscribeStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::SubscribtionEvent, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /** Subscribes to the event broadcast
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/event.v1.EventsService/Subscribe" => {
                    ...
                    for SubscribeSvc<T> {
                        type Response = super::SubscribtionEvent;
