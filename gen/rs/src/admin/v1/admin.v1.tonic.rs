...
*/
        pub async fn delete_station(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/admin.v1.AdminService/DeleteStation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("admin.v1.AdminService", "DeleteStation"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn assign_team(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/admin.v1.AdminService/AssignTeam",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("admin.v1.AdminService", "AssignTeam"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn send_command(
            &mut self,
            request: impl tonic::IntoRequest<super::ClientCommand>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/admin.v1.AdminService/SendCommand",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("admin.v1.AdminService", "SendCommand"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
        async fn send_command(
            &self,
            request: tonic::Request<super::ClientCommand>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    ///
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/admin.v1.AdminService/DeleteStation" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteStationSvc<T: AdminService>(pub Arc<T>);
                    impl<
                        T: AdminService,
                    ...
                    for DeleteStationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdminService>::delete_station(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/admin.v1.AdminService/AssignTeam" => {
                    #[allow(non_camel_case_types)]
                    struct AssignTeamSvc<T: AdminService>(pub Arc<T>);
                    impl<
                        T: AdminService,
                    ...
                    for AssignTeamSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdminService>::assign_team(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/admin.v1.AdminService/SendCommand" => {
                    #[allow(non_camel_case_types)]
                    struct SendCommandSvc<T: AdminService>(pub Arc<T>);
                    impl<
                        T: AdminService,
                    > tonic::server::UnaryService<super::ClientCommand>
                    for SendCommandSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdminService>::send_command(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
