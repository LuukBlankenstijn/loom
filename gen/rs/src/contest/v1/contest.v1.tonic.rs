...
*/
        pub async fn get_next_contest(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/contest.v1.AdminService/GetNextContest",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("contest.v1.AdminService", "GetNextContest"));
...
*/
        pub async fn set_wallpaper(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/contest.v1.AdminService/SetWallpaper",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("contest.v1.AdminService", "SetWallpaper"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn set_wallpaper_text_color(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/contest.v1.AdminService/SetWallpaperTextColor",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("contest.v1.AdminService", "SetWallpaperTextColor"),
                );
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn set_map(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/contest.v1.AdminService/SetMap",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("contest.v1.AdminService", "SetMap"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
    ...
    pub const SERVICE_NAME: &str = "contest.v1.AdminService";
