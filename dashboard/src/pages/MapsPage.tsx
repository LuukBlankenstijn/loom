    ...
    <div className="max-w-5xl mx-auto px-6 py-10">
      <div className="flex items-center gap-3 mb-8">
        ...
        <button
          ...
          className="px-4 py-2 bg-gradient-to-r from-violet-500 to-violet-600 hover:from-violet-600 hover:to-violet-700 text-white rounded-lg transition-all font-medium flex items-center gap-2"
        >
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-gray-500 text-sm mt-1">Create your first map to get started</p>
        </div>
      ) : (
